...
import com.cmv.petGenesis.connection.SQLRegisterUser;
...
//		EnterListener.getInstance().setSignInJPanel(this);
	...
	private void initPanelPersonalData() {
		...
		gbc.gridx = 1;
		gbc.gridy = 1;
		this.jtfName.addKeyListener(EnterListener.getInstance());
		this.jtfName.addFocusListener(EnterListener.getInstance());
		this.panelPersonalData.add(jtfName, gbc);

		gbc.gridx = 1;
		gbc.gridy = 0;
		this.jtfId.addKeyListener(EnterListener.getInstance());
		this.panelPersonalData.add(jtfId, gbc);

		gbc.gridx = 1;
		gbc.gridy = 2;
		this.jtfLastName.addKeyListener(EnterListener.getInstance());
...
//		this.okButton.setActionCommand(EnterCommands.OK_SIGN_IN.toString());
	...
	public void saveDataSignIn(Usuario mod) {
		SQLRegisterUser modSql = new SQLRegisterUser();
